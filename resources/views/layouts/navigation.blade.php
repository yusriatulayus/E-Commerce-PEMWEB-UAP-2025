            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('register') }}"
                        class="text-sm text-white bg-pink-500 px-4 py-2 rounded-md hover:bg-pink-600">Register</a>
                </div>
                @endguest
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="px-4 py-3">
                ...
                <a href="{{ route('register') }}" class="block text-sm text-pink-600 font-semibold">Register</a>
            </div>
            @endguest
